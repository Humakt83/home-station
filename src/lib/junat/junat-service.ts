...
const DEPARTURES_API = 'https://rata.digitraffic.fi/api/v1/live-trains?station=JP&arrived_trains=1&arriving_trains=50&departing_trains=50&departing_trains=5';
